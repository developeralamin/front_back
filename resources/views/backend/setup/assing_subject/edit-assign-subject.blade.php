...
<div class="card-body">
  ...
  <form action="{{  route('setup.assign.subject.update',$editdata['0']->class_id)  }}" method="post" accept-charset="utf-8">
    @csrf
  <div class="add_item">
     <div class="form-row">
...
<div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
    <div class="form-row">
         ...
         <div class="form-group col-md-2">
           ...
           <input type="text" name="full_mark[]" value="{{ $edit->full_mark }}" class="form-control" placeholder="Full Mark" required>         
         </div>

          <div class="form-group col-md-2">
           <label for="">Pass Marks</label>
           <input type="text" name="pass_mark[]" value="{{ $edit->pass_mark }}" class="form-control" placeholder="Pass Mark" required>         
         </div>

         <div class="form-group col-md-2">
           <label for="">Get Marks</label>
           <input type="text" name="get_mark[]" value="{{ $edit->get_mark }}" class="form-control" placeholder="Get Mark" required>         
         </div>
