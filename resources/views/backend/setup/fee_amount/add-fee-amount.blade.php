  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0">Add Student Fee Amount</h1>
          </div><!-- /.col -->
...
<div class="card-header py-3">
       <h6 class="m-0 font-weight-bold text-primary">Add Student Fee Amount</h6>
</div>
  </div>
...
<div class="card-body">
  ...
  <form action="{{  route('amount.store')  }}" method="post" accept-charset="utf-8">
    @csrf
         ...
         <div class="form-group col-md-12">
          ...
          <select name="fee_category_id" class="form-control" required>
           ...
           @foreach($fee_categories as $key => $category)
            <option value="{{ $category->id }}">{{ $category->fee }}</option>}
